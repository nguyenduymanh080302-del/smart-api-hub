...
exports.validatePutBody = void 0;
const inferSchema_1 = require("../utils/inferSchema");
const validatePutBody = (tableName, body) => {
    const table = (0, inferSchema_1.inferSchema)().find(t => t.name === tableName);
    if (!table) {
        return {
            valid: false,
    ...
    const missingFields = allowedFields.filter(field => !bodyFields.includes(field));
